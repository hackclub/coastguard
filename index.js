...
controller.hears('', 'ambient', (bot, message) => {
  ...
  if (
    ...
    bot.whisper(
      message,
      `Ahoy Matey! You posted a message without a file or URL:\n\n"${text}"\n\nI've removed your post for the time being, but you can repost a shipped project with a file or URL and I'll let it be. Let <@U0C7B14Q3> know if you have any questions or if a made a mistake.`
    )
  }
})
